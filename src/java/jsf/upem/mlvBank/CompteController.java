package jsf.upem.mlvBank;

import com.upem.mlvBank.entities.Compte;
import jsf.upem.mlvBank.util.JsfUtil;
import jsf.upem.mlvBank.util.PaginationHelper;
import jpa.upem.mlvBank.CompteFacade;
...
public class CompteController implements Serializable {
    ...
    @EJB
    private jpa.upem.mlvBank.CompteFacade ejbFacade;
